                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      fullWidth
                      value={currentConfig?.database?.dynamodb?.workersTable || 'Workers'}
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12}>
                    ...
                    <TextField
                      ...
                      multiline
                      rows={10}
                      value={JSON.stringify(currentConfig?.database?.local?.workers || [], null, 2)}
                      onChange={(e) => {
                        try {
                          handleLocalDBChange('workers', JSON.parse(e.target.value));
                        } catch (error) {
                      ...
                      helperText="JSON de profissionais no formato: [{'worker_id': '1', 'name': 'Nome', 'specialties': []}]"
                    />
                  </Grid>
                  <Grid item xs={12}>
                    <Typography variant="subtitle1" gutterBottom>
                    ...
                    <TextField
                      ...
                      margin="normal"
                      disabled={!currentConfig?.database?.local?.enabled}
                      helperText="JSON de agendamentos no formato: [{'appointment_id': '1', 'date': '2023-01-01', 'worker_id': '1', 'client_name': 'Nome'}]"
                    />
                  </Grid>
                  <Grid item xs={12}>
                    <Alert severity="info" sx={{ mt: 2 }}>
